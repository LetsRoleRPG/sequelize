...
const container = require("../../../../../dist/src/DependencyInjection/Container");
const Services = require("../../../../../dist/src/DependencyInjection/Services");
...
class Query extends AbstractQuery {
  ...
  async run(sql, parameters) {
    ...
    try {
      results = await this.sequelize.config.dialectOptions.sqlServer().query(this.sql, parameters);
    } catch (error) {
      console.log(error);
