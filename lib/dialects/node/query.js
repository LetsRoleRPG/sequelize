...
const {container} = require("../../../../../src/DependencyInjection/Container");
const {SqlServer} = require("../../../../../src/SqlServer");
const {Services} = require("../../../../../src/DependencyInjection/Services");
...
const debug = logger.debugContext('sql:node');
...
class Query extends AbstractQuery {
  ...
  async run(sql, parameters) {
    ...
    try {
      results = await container.get<SqlServer>(Services.SqlServer).query(this.sql, parameters);
    } catch (error) {
